                            ...
                            @foreach($headerProducts['sliderProducts'] as $product)
                                <div class="single-slider"
                                    ...
                                    <div class="content">
                                        ...
                                        <h3><span>Now Only</span>{{money($product->discount_price)}}</h3>
                                        <div class="button">
                                            <a href="{{route('products.show',$product)}}" class="btn">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="hero-small-banner"
                                ...
                                <div class="content">
                                    <h2>
                                        ...
                                        {{$headerProducts['product']->name}}
                                    </h2>
                                    <h3>{{money($headerProducts['product']->price)}}</h3>
                                </div>
                            </div>
                            <!-- End Small Banner -->
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                @foreach($trendingProduct as $product)
                    @include('partials._single_product',['product' => $product,'class'=> ['col-lg-3', 'col-md-6' ,'col-12']])
                @endforeach
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-12">
                    <div class="row">
                        @foreach($specialOffer['threeProducts'] as $product )
                            @include('partials._single_product',['product' => $product])
                        @endforeach
                    </div>
                    <!-- Start Banner -->
                    <div class="single-banner right"
                        ...
                        <div class="content">
                            <h2>{{$specialOffer['bottomProduct']->name}}</h2>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="offer-content">
                        <div class="image">
                            ...
                            @if($specialOffer['specialProduct']->discount)
                                <span class="sale-tag">-{{$specialOffer['specialProduct']->discount}}%</span>
                            @endif
                        </div>
                        <div class="text">
                            <h2>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-12 custom-responsive-margin">
                    ...
                    @foreach($bestSellers as $product)
                        @include('partials._small_product_item', ['product' => $product])
                    @endforeach
                </div>
                <div class="col-lg-4 col-md-4 col-12 custom-responsive-margin">
